...
var _meta = {
  ...
  props: {
    ...
    size: _without(SUI.SIZES, 'medium', 'big'),
    tabular: ['right'],
    widths: SUI.WIDTHS
  }
};
...
var Menu = function (_Component) {
  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      var classes = cx('ui', color, size, useWidthProp(widths, 'item'), useKeyOrValueAndKey(attached, 'attached'), useKeyOnly(borderless, 'borderless'), useKeyOnly(compact, 'compact'), useValueAndKey(fixed, 'fixed'), useKeyOrValueAndKey(floated, 'floated'), useKeyOnly(fluid, 'fluid'), useKeyOrValueAndKey(icon, 'icon'), useKeyOnly(inverted, 'inverted'), useKeyOnly(pagination, 'pagination'), useKeyOnly(pointing, 'pointing'), useKeyOnly(secondary, 'secondary'), useKeyOnly(stackable, 'stackable'), useKeyOrValueAndKey(tabular, 'tabular'), useKeyOnly(text, 'text'), useKeyOnly(vertical, 'vertical'), className, 'menu');
...
process.env.NODE_ENV !== "production" ? Menu.propTypes = {
  ...
  attached: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(_meta.props.attached)]),
  ...
  floated: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(_meta.props.floated)]),

  /** A vertical menu may take the size of its container. */
  fluid: PropTypes.bool,

  /** A menu may have labeled icons. */
  icon: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(_meta.props.icon)]),
  ...
  tabular: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(_meta.props.tabular)]),
