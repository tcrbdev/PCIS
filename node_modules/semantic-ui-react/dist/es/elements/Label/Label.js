...
process.env.NODE_ENV !== "production" ? Label.propTypes = {
  ...
  corner: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(_meta.props.corner)]),

  /** Shorthand for LabelDetail. */
  detail: customPropTypes.itemShorthand,

  /** Formats the label as a dot. */
  empty: customPropTypes.every([customPropTypes.demand(['circular']), PropTypes.bool]),
  ...
  ribbon: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(_meta.props.ribbon)]),
