...
function ItemGroup(props) {
  ...
  var classes = cx('ui', className, useKeyOnly(divided, 'divided'), useKeyOnly(link, 'link'), useKeyOrValueAndKey(relaxed, 'relaxed'), 'items');
...
process.env.NODE_ENV !== "production" ? ItemGroup.propTypes = {
  ...
  relaxed: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(ItemGroup._meta.props.relaxed)])
} : void 0;
