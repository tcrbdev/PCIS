...
import { AutoControlledComponent as Component, META, customPropTypes, getUnhandledProps, getElementType, useKeyOnly } from '../../lib';
...
var Sidebar = function (_Component) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function render() {
      ...
      var classes = cx('ui', 'sidebar', useKeyOnly(animating, 'animating'), direction, width, animation, useKeyOnly(visible, 'visible'), className);
